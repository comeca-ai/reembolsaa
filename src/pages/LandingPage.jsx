    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Link to="/" className="text-sm text-muted-foreground hover:text-foreground transition-colors hidden md:block">
            Entrar
          </Link>
          <Link to="/" className="bg-primary text-primary-foreground text-sm font-medium px-4 py-2 rounded-lg hover:bg-primary/90 transition-colors">
            Começar grátis
          </Link>
        </div>
      </div>
  ...
  return (
    <section className="pt-32 pb-20 px-6">
      <div className="max-w-4xl mx-auto text-center space-y-8">
        ...
        >
          <Link to="/" className="inline-flex items-center gap-2 bg-primary text-primary-foreground font-medium px-6 py-3 rounded-xl hover:bg-primary/90 transition-all hover:scale-105 text-base">
            Começar grátis
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {PLANS.map(({ name, price, period, desc, features, cta, highlight }) => (
            ...
            >
              ...
              <Link to="/" className={`block text-center py-2.5 rounded-xl text-sm font-medium transition-all hover:scale-105 ${
                highlight
  ...
  return (
    <section className="py-24 px-6">
      <div className="max-w-2xl mx-auto text-center space-y-8">
        ...
        <Link to="/" className="inline-flex items-center gap-2 bg-primary text-primary-foreground font-medium px-8 py-4 rounded-xl hover:bg-primary/90 transition-all hover:scale-105 text-base">
