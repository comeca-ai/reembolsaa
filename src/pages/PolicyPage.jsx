...
import { Shield, Upload, Loader2, Wand2, FileText, Inbox } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-8 md:py-12 space-y-8">
        ...
        <motion.div initial={{ opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-heading text-foreground text-2xl md:text-3xl">Política de reembolso</h1>
